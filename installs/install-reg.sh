...
# This is only the install-reg script for working on slurm with enroot images. The detailed package list is elsewhere and can be installed with install_requirements
